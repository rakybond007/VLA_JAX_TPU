#!/bin/bash
#SBATCH --job-name="vla-libero-qwen3vl-2gpu-40k"
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=gpu
#SBATCH --output=slurm_out/%j-vla_libero_qwen3vl_2gpu_40k.out
#SBATCH --error=slurm_out/%j-vla_libero_qwen3vl_2gpu_40k.err
...
# User-tunable knobs
# =============================
RUN_NAME="${RUN_NAME:-libero-qwen3vl-flow-2gpu-40k}"
...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-$ROOT_DIR/outputs/checkpoints/libero_full_jax_qwen3_vl_2gpu_40k}"
